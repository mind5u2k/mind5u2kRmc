				...
				<c:if test="${userModel.role == 'Approver'}">
					<div class="btn-group">
						<button type="button" class="btn btn-warning"
							onclick="window.location.href='${contextRoot}/approver/addAccSpecControls?assCatId=${selectedAssessmentCategory.id}'"
							...
							<c:forEach items="${answerModels}" var="answerModel">
								...
								<tr>
									<td style="white-space: nowrap;">${i}&nbsp;<a
										...
										title="${answerModel.answer.control.control.helpData}"
										style="padding: 0px 6px; cursor: pointer;"><i
											class="fa fa-question" aria-hidden="true"></i></a></td>
									<td>${answerModel.answer.control.control.control}</td>
									<c:if test="${answerModel.status==false}">
										<td class="btn-danger" style="text-align: center;">! Not
											Responded</td>
									</c:if>
									<c:if test="${answerModel.status==true}">
										<td>${answerModel.answer.answer}</td>
									</c:if>
									<td>${answerModel.answer.comment}</td>

									<c:if test="${userModel.role == 'Approver'}">
										<td><a
											href="${contextRoot}/approver/download/${answerModel.answer.id}"
											target="_blank">${answerModel.answer.artifaceName}</a></td>
									</c:if>
									<c:if test="${userModel.role == 'Assessor'}">
										<td><a
											href="${contextRoot}/assessor/download/${answerModel.answer.id}"
											target="_blank">${answerModel.answer.artifaceName}</a></td>
									</c:if>
									<c:if test="${userModel.role == 'Reviewer'}">
										<td><a
											href="${contextRoot}/reviewer/download/${answerModel.answer.id}"
											target="_blank">${answerModel.answer.artifaceName}</a></td>
									</c:if>
									<c:if test="${userModel.role == 'SME'}">
										<td><a
											href="${contextRoot}/sme/download/${answerModel.answer.id}"
											target="_blank">${answerModel.answer.artifaceName}</a></td>
									</c:if>
									<c:if test="${userModel.role == 'Admin'}">
										<td><a
									...
									<c:if test="${userModel.role == 'Approver'}">
										<td style="text-align: center;"><a
											...
											href="${contextRoot}/approver/responsePage?accSpecCtrlId=${answerModel.answer.control.id}"
											style="padding: 0px 6px; cursor: pointer;"><i
									...
									<c:if test="${userModel.role == 'Assessor'}">
										<td style="text-align: center;"><a
											class="btn btn-warning"
											href="${contextRoot}/assessor/responsePage?accSpecCtrlId=${answerModel.answer.control.id}"
											style="padding: 0px 6px; cursor: pointer;"><i
												class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
									</c:if>
									<c:if test="${userModel.role == 'SME'}">
										<td style="text-align: center;"><a
											class="btn btn-warning"
											href="${contextRoot}/sme/responsePage?accSpecCtrlId=${answerModel.answer.control.id}"
											style="padding: 0px 6px; cursor: pointer;"><i
												class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
									</c:if>
									...
									<c:if test="${userModel.role == 'Assessor'}">
										...
										<c:if test="${answerModel.status==true}">
											<td style="text-align: center;"><a
												...
												data-target="#myModal"
												onclick="return showHistoryAssessor(${answerModel.answer.id});"
												style="padding: 0px 6px; cursor: pointer;"><i
													class="fa fa-history" aria-hidden="true"></i></a></td>
										</c:if>
									</c:if>
									<c:if test="${userModel.role == 'Approver'}">
										...
										<c:if test="${answerModel.status==true}">
											<td style="text-align: center;"><a
												class="btn btn-dark historyBtn" data-toggle="modal"
												data-target="#myModal"
												onclick="return showHistory(${answerModel.answer.id});"
												style="padding: 0px 6px; cursor: pointer;"><i
													class="fa fa-history" aria-hidden="true"></i></a></td>
										</c:if>
									</c:if>
									<c:if test="${userModel.role == 'Reviewer'}">
										...
										<c:if test="${answerModel.status==true}">
											<td style="text-align: center;"><a
												class="btn btn-dark historyBtn" data-toggle="modal"
												data-target="#myModal"
												onclick="return showHistoryReviewer(${answerModel.answer.id});"
												style="padding: 0px 6px; cursor: pointer;"><i
													class="fa fa-history" aria-hidden="true"></i></a></td>
										</c:if>
									</c:if>
									<c:if test="${userModel.role == 'SME'}">
										...
										<c:if test="${answerModel.status==true}">
											<td style="text-align: center;"><a
												class="btn btn-dark historyBtn" data-toggle="modal"
												data-target="#myModal"
												onclick="return showHistorySme(${answerModel.answer.id});"
												style="padding: 0px 6px; cursor: pointer;"><i
													class="fa fa-history" aria-hidden="true"></i></a></td>
										</c:if>
									</c:if>
			...
			<div class="row">
				<div class="col-xl-12" style="text-align: center;">
					<button class="btn btn-primary" style="cursor: pointer;"
						onclick="window.location.href='completeAssessment?assId=${assessment.id}'">Complete
						Assessment</button>
				</div>
			</div>
		</c:if>
