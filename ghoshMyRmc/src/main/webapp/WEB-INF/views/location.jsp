...
<div class="modal fade" id="editLocationModel" tabindex="-1"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body editLocationModelBody"></div>
		</div>
...
function editLocation(locationId) { 
	$('.editLocationModelBody').load('${contextRoot}/admin/editLocation?locationId=' + locationId,
			function() {

				$('#editLocationModel').modal({
					show : true
				});
			});
