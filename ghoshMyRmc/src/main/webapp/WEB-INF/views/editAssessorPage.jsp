...
<sf:form modelAttribute="assessment" id="editApproverForm"
	action="${contextRoot}/admin/updateAssessor" method="POST">
	<div class="modal-body editApproverModelBody">
		<div class="form-group row">
			<label for="example-text-input" class="col-2 col-form-label">Approver</label>
			<div class="col-10">
				<sf:select class="form-control" id="assessor.id" path="assessor.id"
					items="${assessors}" itemLabel="name" itemValue="id" />
			</div>
		</div>
	</div>
