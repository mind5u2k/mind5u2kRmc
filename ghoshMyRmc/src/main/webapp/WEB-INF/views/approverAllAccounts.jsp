					...
					<c:forEach items="${assessmentModel.assessments}" var="assessment"
						...
						<tr>
							...
							<td style="text-align: center;"><a class="btn btn-dark"
								href="${contextRoot}/approver/assessmentPage?assessmentId=${assessment.id}"
							...
							<c:if test="${assessment.assessmentStatus=='Submitted'}">
								<td style="text-align: center;"><a class="btn btn-dark"
									href="${contextRoot}/approver/riskTracker?assessmentId=${assessment.id}"
									style="padding: 0px 6px; cursor: pointer;"><i
							...
							<c:if test="${assessment.assessmentStatus=='Submitted'}">
								<td style="text-align: center;"><a class="btn btn-dark"
									href="${contextRoot}/approver/riskAnalysis?assId=${assessment.id}"
									style="padding: 0px 6px; cursor: pointer;"><i
